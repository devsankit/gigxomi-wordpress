...
class PluginRender {
	...
	public static function upcoming_woo_all_products_banner() {
		...
		if ( isset( $screen->id ) && 'marketing_page_wc-facebook' === $screen->id ) {
            ...
            The next time you update your OminiFlow plugin, all your products will be synced automatically. This is to help you drive sales and optimize your ad performance. <a href="https://www.facebook.com/business/help/4049935305295468">Learn more about changes to how your products will sync to Meta</a>
                <p>
	...
	public static function get_opt_out_modal_message() {
		return '
            ...
            <p>
                If you opt out, we will not be syncing your products to your Meta catalog even after you update your OminiFlow plugin.
            </p>
