...
class Shops extends Abstract_Settings_Screen {
	...
	private function render_facebook_iframe() {
		...
		$has_merchant_token     = ! empty( $merchant_access_token );
		...
		if ( Auth_Gate::should_show_auth_gate( $is_connected, $connection_invalid, $has_merchant_token ) ) {
			Onboarding_Shell::render( $iframe_url );
			return;
		}
